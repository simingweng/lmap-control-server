 ...
 */
@ApiModel(description = "Configuration of a particular suppression.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-05-12T22:37:00.102Z")

public class InlineResponse200SuppressionsSuppression   {
  @JsonProperty("name")
  ...
  public InlineResponse200SuppressionsSuppression name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse200SuppressionsSuppression start(String start) {
    this.start = start;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse200SuppressionsSuppression end(String end) {
    this.end = end;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse200SuppressionsSuppression stopRunning(Boolean stopRunning) {
  ...
  **/
  ...
  public InlineResponse200SuppressionsSuppression match(List<String> match) {
    this.match = match;
    return this;
  }

  public InlineResponse200SuppressionsSuppression addMatchItem(String matchItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InlineResponse200SuppressionsSuppression inlineResponse200SuppressionsSuppression = (InlineResponse200SuppressionsSuppression) o;
    return Objects.equals(this.name, inlineResponse200SuppressionsSuppression.name) &&
        Objects.equals(this.start, inlineResponse200SuppressionsSuppression.start) &&
        Objects.equals(this.end, inlineResponse200SuppressionsSuppression.end) &&
        Objects.equals(this.stopRunning, inlineResponse200SuppressionsSuppression.stopRunning) &&
        Objects.equals(this.match, inlineResponse200SuppressionsSuppression.match);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse200SuppressionsSuppression {\n");
