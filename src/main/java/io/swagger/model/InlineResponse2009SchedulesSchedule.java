 ...
 */
@ApiModel(description = "State of a particular schedule.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.SpringCodegen", date = "2017-05-12T22:37:00.102Z")

public class InlineResponse2009SchedulesSchedule   {
  @JsonProperty("name")
  ...
  public InlineResponse2009SchedulesSchedule name(String name) {
    this.name = name;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2009SchedulesSchedule state(StateEnum state) {
    this.state = state;
    return this;
  }
  ...
  **/
  ...
  public InlineResponse2009SchedulesSchedule invocations(Integer invocations) {
  ...
  **/
  ...
  public InlineResponse2009SchedulesSchedule suppressions(Integer suppressions) {
  ...
  **/
  ...
  public InlineResponse2009SchedulesSchedule overlaps(Integer overlaps) {
  ...
  **/
  ...
  public InlineResponse2009SchedulesSchedule failures(Integer failures) {
  ...
  **/
  ...
  public InlineResponse2009SchedulesSchedule lastInvocation(String lastInvocation) {
  ...
  **/
  ...
  public InlineResponse2009SchedulesSchedule action(List<InlineResponse2009SchedulesAction> action) {
    this.action = action;
    return this;
  }

  public InlineResponse2009SchedulesSchedule addActionItem(InlineResponse2009SchedulesAction actionItem) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    InlineResponse2009SchedulesSchedule inlineResponse2009SchedulesSchedule = (InlineResponse2009SchedulesSchedule) o;
    return Objects.equals(this.name, inlineResponse2009SchedulesSchedule.name) &&
        Objects.equals(this.state, inlineResponse2009SchedulesSchedule.state) &&
        Objects.equals(this.invocations, inlineResponse2009SchedulesSchedule.invocations) &&
        Objects.equals(this.suppressions, inlineResponse2009SchedulesSchedule.suppressions) &&
        Objects.equals(this.overlaps, inlineResponse2009SchedulesSchedule.overlaps) &&
        Objects.equals(this.failures, inlineResponse2009SchedulesSchedule.failures) &&
        Objects.equals(this.lastInvocation, inlineResponse2009SchedulesSchedule.lastInvocation) &&
        Objects.equals(this.action, inlineResponse2009SchedulesSchedule.action);
  }
  ...
  public String toString() {
    ...
    sb.append("class InlineResponse2009SchedulesSchedule {\n");
